...
evaluation <- ENMevaluate (dbroteridata, vars.stack, dbroteri_backdata, method = "jackknife", rasterPreds = T, bin.output=TRUE)
evaluation_di <- ENMevaluate (dbroteri_di, vars.stack, dbroteri_backdata, method = "jackknife", rasterPreds = T, bin.output=TRUE)
evaluation_te <- ENMevaluate (dbroteri_te, vars.stack, dbroteri_backdata, method = "jackknife", rasterPreds = T, bin.output=TRUE)
evaluation_he <- ENMevaluate (dbroteri_he, vars.stack, dbroteri_backdata, method = "jackknife", rasterPreds = T, bin.output=TRUE)
evaluation_do <- ENMevaluate (dbroteri_do, vars.stack, dbroteri_backdata, method = "jackknife", rasterPreds = T, bin.output=TRUE)
