 # Diferencias de nicho usando el mismo background (i.e no corrigiendo por l os background de las distintas especies)
...
gcol = c("blue", "red", "green", "yellow", "grey")
...
#ecospat (tests)
equivalency.test.dite<-ecospat.niche.equivalency.test (zdi, zte, 100, alternative = "lower", ncores = detectCores() - 1)
equivalency.test.dihe<-ecospat.niche.equivalency.test (zdi, zhe, 100, alternative = "lower", ncores = detectCores() - 1)
equivalency.test.dido<-ecospat.niche.equivalency.test (zdi, zdo, 100, alternative = "lower", ncores = detectCores() - 1)
equivalency.test.tehe<-ecospat.niche.equivalency.test (zte, zhe, 100, alternative = "lower", ncores = detectCores() - 1)
equivalency.test.tedo<-ecospat.niche.equivalency.test (zte, zdo, 100, alternative = "lower", ncores = detectCores() - 1)
equivalency.test.hedo<-ecospat.niche.equivalency.test (zhe, zdo, 100, alternative = "lower", ncores = detectCores() - 1)

gequivalency.test.dite<-ecospat.niche.equivalency.test (zdi, zte, 100, alternative = "greater", ncores = detectCores() - 1)
gequivalency.test.dihe<-ecospat.niche.equivalency.test (zdi, zhe, 100, alternative = "greater", ncores = detectCores() - 1)
gequivalency.test.dido<-ecospat.niche.equivalency.test (zdi, zdo, 100, alternative = "greater", ncores = detectCores() - 1)
gequivalency.test.tehe<-ecospat.niche.equivalency.test (zte, zhe, 100, alternative = "greater", ncores = detectCores() - 1)
gequivalency.test.tedo<-ecospat.niche.equivalency.test (zte, zdo, 100, alternative = "greater", ncores = detectCores() - 1)
gequivalency.test.hedo<-ecospat.niche.equivalency.test (zhe, zdo, 100, alternative = "greater", ncores = detectCores() - 1)
...
similarity.testdite<-ecospat.niche.similarity.test (zdi, zte, 100, alternative = "lower", ncores = detectCores() - 1)
similarity.testtedi<-ecospat.niche.similarity.test (zte, zdi, 100, alternative = "lower", ncores = detectCores() - 1)
similarity.testdihe<-ecospat.niche.similarity.test (zdi, zhe, 100, alternative = "lower", ncores = detectCores() - 1)
similarity.testhedi<-ecospat.niche.similarity.test (zhe, zdi, 100, alternative = "lower", ncores = detectCores() - 1)
similarity.testdido<-ecospat.niche.similarity.test (zdi, zdo, 100, alternative = "lower", ncores = detectCores() - 1)
similarity.testdodi<-ecospat.niche.similarity.test (zdo, zdi, 1000, alternative = "lower", ncores = detectCores() - 1)
similarity.testtehe<-ecospat.niche.similarity.test (zte, zhe, 1000, alternative = "lower", ncores = detectCores() - 1)
similarity.testhete<-ecospat.niche.similarity.test (zhe, zte, 1000, alternative = "lower", ncores = detectCores() - 1)
similarity.testtedo<-ecospat.niche.similarity.test (zte, zdo, 1000, alternative = "lower", ncores = detectCores() - 1)
similarity.testdote<-ecospat.niche.similarity.test (zdo, zte, 1000, alternative = "lower", ncores = detectCores() - 1)
similarity.testhedo<-ecospat.niche.similarity.test (zhe, zdo, 1000, alternative = "lower", ncores = detectCores() - 1)
similarity.testdohe<-ecospat.niche.similarity.test (zdo, zhe, 1000, alternative = "lower", ncores = detectCores() - 1)

gsimilarity.testdite<-ecospat.niche.similarity.test (zdi, zte, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testtedi<-ecospat.niche.similarity.test (zte, zdi, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testdihe<-ecospat.niche.similarity.test (zdi, zhe, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testhedi<-ecospat.niche.similarity.test (zhe, zdi, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testdido<-ecospat.niche.similarity.test (zdi, zdo, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testdodi<-ecospat.niche.similarity.test (zdo, zdi, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testtehe<-ecospat.niche.similarity.test (zte, zhe, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testhete<-ecospat.niche.similarity.test (zhe, zte, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testtedo<-ecospat.niche.similarity.test (zte, zdo, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testdote<-ecospat.niche.similarity.test (zdo, zte, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testhedo<-ecospat.niche.similarity.test (zhe, zdo, 1000, alternative = "greater", ncores = detectCores() - 1)
gsimilarity.testdohe<-ecospat.niche.similarity.test (zdo, zhe, 1000, alternative = "greater", ncores = detectCores() - 1)
